...
import DummyTitles from "../components/dummyTitles";
...
const About = ({data}) => {
    return (
        <>
            ...
            <div>
                {/*Top bar*/}
                <div className='flex  bg-[#E0F3F9] h-40 whitespace-nowrap'>
                    ...
                    <div className='p-4  '>
                        <p className='hover:cursor-pointer flex flex-nowrap gap-2 '><span
                            ...
                            className='hover:underline hover:underline-offset-1 hover:decoration-2'>Om fylkeskommunen</span></p>
                    </div>

                    {/*Heading*/}
                    <div className='flex justify-center items-center'>
                        <h1 className='text-5xl font-semibold'>Om fylkeskommunen</h1>
                    </div>
